...
export default function Home() {
  ...
  const updateURL = ({ category, sort, search }: { category: string; sort: string; search: string }) => {
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex items-center">
                    <CardContent className="p-8 text-white">
                      <h1 className="text-4xl font-bold mb-4">최신 웹 개발 트렌드와 기술</h1>
                      <p className="text-xl mb-6 opacity-90">
                        프론트엔드 개발자를 위한 실무 중심의 기술 블로그입니다. React, TypeScript, 성능 최적화 등 다양한 주제를 다룹니다.
                      </p>
                      <Button onClick={() => navigate("/contact")} className="bg-white text-black hover:bg-gray-100">
              ...
              <Card className="toss-card text-center py-12">
                <CardContent>
                  ...
                  <p className="text-gray-400 mt-2">
                    {searchQuery ? "다른 키워드로 검색해보세요." : "곧 새로운 글을 업로드할 예정입니다."}
                  </p>
                </CardContent>
              </Card>
            ) : (
