    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          궁금한 점이 있으시거나 협업을 원하신다면 언제든 연락해주세요. 
      ...
      <div className="grid lg:grid-cols-2 gap-12">
          ...
          <Card className="toss-card">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                5년차 프론트엔드 개발자로 React, TypeScript, Next.js 등의 기술을 주로 다룹니다. 
                웹 성능 최적화와 사용자 경험 개선에 관심이 많으며, 
            ...
            <CardContent className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">developer@example.com</p>
                </div>
              </a>
              ...
              <a 
                ...
                className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors group"
              >
                <div className="w-10 h-10 bg-gray-800 dark:bg-gray-700 rounded-lg flex items-center justify-center group-hover:bg-gray-900 dark:group-hover:bg-gray-600 transition-colors">
                  <Github className="w-5 h-5 text-white" />
                </div>
                <div>
                  <p className="font-medium">GitHub</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">github.com/developer</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">linkedin.com/in/developer</p>
                </div>
              </a>
            </CardContent>
          </Card>
        ...
        <div>
          ...
          <Card className="toss-card mt-8">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-medium mb-1">프로젝트 협업이 가능한가요?</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  네, 흥미로운 프로젝트라면 언제든 협업하고 싶습니다. 
                  프로젝트 규모와 일정을 알려주시면 검토 후 답변드리겠습니다.
                </p>
              </div>
              <div>
                <h4 className="font-medium mb-1">기술 상담이 가능한가요?</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  React, TypeScript, 웹 성능 최적화 등의 분야에서 
                  간단한 기술 상담은 가능합니다.
                </p>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  보통 1-2일 내에 답변드리려고 노력하고 있습니다. 
                  급한 사항의 경우 제목에 [긴급]을 표시해주세요.
                </p>
              </div>
            </CardContent>
          </Card>
