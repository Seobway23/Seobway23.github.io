...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#4A90D9', 'primaryTextColor': '#fff', 'primaryBorderColor': '#2c6fad', 'lineColor': '#555', 'secondaryColor': '#f0f4f8', 'tertiaryColor': '#e8f5e9'}}}%%
flowchart LR
    GIT[("Git Push\n/ MR")] --> PL[Pipeline 생성]
    PL --> R1[Runner\nContainer A]
    PL --> R2[Runner\nContainer B]
    ...
    classDef git fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef pl fill:#4A90D9,stroke:#2c6fad,color:#fff
    classDef runner fill:#6db33f,stroke:#4a8a2a,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#4A90D9', 'primaryTextColor': '#fff', 'primaryBorderColor': '#2c6fad', 'lineColor': '#555', 'edgeLabelBackground': '#f0f4f8'}}}%%
flowchart TD
    ...
    classDef stage_build fill:#4A90D9,stroke:#2c6fad,color:#fff
    classDef stage_deploy fill:#6db33f,stroke:#4a8a2a,color:#fff
    classDef stage_verify fill:#f0a500,stroke:#c07800,color:#fff
    classDef stage_rollback fill:#e74c3c,stroke:#a93226,color:#fff
    classDef terminal_ok fill:#27ae60,stroke:#1e8449,color:#fff
    classDef terminal_fail fill:#c0392b,stroke:#922b21,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#4A90D9', 'primaryTextColor': '#fff', 'primaryBorderColor': '#2c6fad', 'lineColor': '#555'}}}%%
flowchart LR
    ...
    classDef gl fill:#8e44ad,stroke:#6c3483,color:#fff
    classDef job fill:#4A90D9,stroke:#2c6fad,color:#fff
...
flowchart LR
    ...
    classDef k3s fill:#e67e22,stroke:#ca6f1e,color:#fff
    classDef proc fill:#4A90D9,stroke:#2c6fad,color:#fff
    classDef var fill:#8e44ad,stroke:#6c3483,color:#fff
    classDef job fill:#6db33f,stroke:#4a8a2a,color:#fff
...
flowchart TD
    ...
    classDef action fill:#4A90D9,stroke:#2c6fad,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#6db33f', 'primaryTextColor': '#fff', 'primaryBorderColor': '#4a8a2a', 'lineColor': '#555'}}}%%
flowchart TD
    ...
    classDef env fill:#34495e,stroke:#2c3e50,color:#fff
    classDef kube fill:#e67e22,stroke:#ca6f1e,color:#fff
    classDef deploy fill:#6db33f,stroke:#4a8a2a,color:#fff
...
flowchart LR
    ...
    classDef ok fill:#6db33f,stroke:#4a8a2a,color:#fff
    classDef gone fill:#e74c3c,stroke:#a93226,color:#fff
    classDef vm fill:#34495e,stroke:#2c3e50,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#4A90D9', 'primaryTextColor': '#fff', 'primaryBorderColor': '#2c6fad', 'lineColor': '#555', 'clusterBkg': '#f0f4f8', 'clusterBorder': '#b0c4de'}}}%%
flowchart TB
    DEV[/"👨‍💻 개발자\nGit Push"/]
    ...
    classDef dev fill:#8e44ad,stroke:#6c3483,color:#fff
    classDef gl fill:#4A90D9,stroke:#2c6fad,color:#fff
    classDef ci_build fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef ci_deploy fill:#6db33f,stroke:#4a8a2a,color:#fff
    classDef ci_verify fill:#f0a500,stroke:#c07800,color:#fff
    classDef ci_rollback fill:#e74c3c,stroke:#a93226,color:#fff
    classDef registry fill:#e67e22,stroke:#ca6f1e,color:#fff
    classDef k3s fill:#16a085,stroke:#0e6655,color:#fff
