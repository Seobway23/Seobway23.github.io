...
[^ixp]: Internet exchange point — <a href="https://en.wikipedia.org/wiki/Internet_exchange_point" target="_blank">https://en.wikipedia.org/wiki/Internet_exchange_point</a>
[^peering]: Peering — <a href="https://en.wikipedia.org/wiki/Peering" target="_blank">https://en.wikipedia.org/wiki/Peering</a>
[^bgp]: Border Gateway Protocol — <a href="https://en.wikipedia.org/wiki/Border_Gateway_Protocol" target="_blank">https://en.wikipedia.org/wiki/Border_Gateway_Protocol</a>
[^as]: Autonomous system (Internet) — <a href="https://en.wikipedia.org/wiki/Autonomous_system_(Internet)" target="_blank">https://en.wikipedia.org/wiki/Autonomous_system_(Internet)</a>
[^kinx]: KINX — <a href="https://en.wikipedia.org/wiki/Korea_Internet_Neutral_Exchange" target="_blank">https://en.wikipedia.org/wiki/Korea_Internet_Neutral_Exchange</a>
