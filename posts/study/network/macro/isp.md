...
- [IXP — ISP들이 만나는 물리적 교차로](./ixp): 피어링이 실제로 일어나는 물리적 공간
- [CDN — 콘텐츠를 가장 빠른 경로로 전달하는 방법](./cdn): ISP 네트워크 위에서 작동하는 콘텐츠 배포 전략
- [회선 교환 vs 패킷 교환](./circuit-vs-packet-switching): 인터넷이 선택한 데이터 전달 방식

---

[^isp]: Internet Service Provider — <a href="https://en.wikipedia.org/wiki/Internet_service_provider" target="_blank">https://en.wikipedia.org/wiki/Internet_service_provider</a>
[^tier1]: Tier 1 network — <a href="https://en.wikipedia.org/wiki/Tier_1_network" target="_blank">https://en.wikipedia.org/wiki/Tier_1_network</a>
