import{H as m,j as M,t as N,x as O}from"./app-Ckep5sj6.js";let A=!1;function P(){A||(m.registerLanguage("javascript",M),m.registerLanguage("typescript",N),m.registerLanguage("xml",O),m.configure({ignoreUnescapedHTML:!0}),A=!0)}const T={react:"javascript",ts:"typescript",js:"javascript",html:"xml"};function U(e){P(),delete e.dataset.highlighted;try{m.highlightElement(e)}catch{}}const v="18.3.1",x="https://esm.sh",H="https://cdn.jsdelivr.net/npm/@babel/standalone@7.26.4/babel.min.js";function B(e){const t=String(e||"").split(/\r?\n/);let o="react",s="",l=300;if(/^\s*(#!|%%)/.test(t[0]||"")){const i=t[0].replace(/^\s*(#!|%%)\s*/,"");t.shift();const b=i.match(/\b(react|ts|js|html)\b/);b&&(o=b[1]);const f=i.match(/title=("([^"]*)"|(\S+))/);f&&(s=(f[2]??f[3]??"").trim());const d=i.match(/height=(\d+)/);d&&(l=Math.max(140,Math.min(720,Number(d[1]))))}return{kind:o,title:s||{react:"App.jsx",ts:"App.tsx",js:"main.js",html:"index.html"}[o],height:l,code:t.join(`
