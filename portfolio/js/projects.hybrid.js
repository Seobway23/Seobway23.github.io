// HYBRID: high DPR (clarity like baseline) + overlay pause/resume + pointermove rAF throttle
...
// Hybrid choices
const MAX_DPR = 2.0; // restore clarity
...
// Keep the pause/resume behavior (this is what makes overlays feel instant)
...
function onPointerMove(e) {
  // Hybrid keeps the rAF throttle (cheap win, doesn't reduce clarity)
  lastPointerEvent = e;
