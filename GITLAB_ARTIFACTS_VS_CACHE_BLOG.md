...
flowchart LR
    ...
    classDef job_a fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef job_b fill:#e74c3c,stroke:#a93226,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#2c6fad', 'primaryTextColor': '#fff', 'primaryBorderColor': '#1a4a7a', 'lineColor': '#555', 'clusterBkg': '#eef4fb', 'clusterBorder': '#b0c4de'}}}%%
flowchart LR
    ...
    classDef build fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef gl fill:#e67e22,stroke:#ca6f1e,color:#fff
    classDef test fill:#8e44ad,stroke:#6c3483,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#2c6fad', 'primaryTextColor': '#fff', 'primaryBorderColor': '#1a4a7a', 'lineColor': '#555'}}}%%
flowchart TD
    ROOT["artifacts 심화"]
    ...
    classDef root fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef detail fill:#4A90D9,stroke:#2c6fad,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#8e44ad', 'primaryTextColor': '#fff', 'primaryBorderColor': '#6c3483', 'lineColor': '#555', 'clusterBkg': '#f5f0fa', 'clusterBorder': '#c39bd3'}}}%%
flowchart TB
    ...
    classDef pipe1 fill:#8e44ad,stroke:#6c3483,color:#fff
    classDef pipe2 fill:#16a085,stroke:#0e6655,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#8e44ad', 'primaryTextColor': '#fff', 'primaryBorderColor': '#6c3483', 'lineColor': '#555'}}}%%
flowchart TD
    ROOT["cache key 전략"]
    ...
    classDef detail fill:#a569bd,stroke:#8e44ad,color:#fff
...
flowchart LR
    ...
    classDef art fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef cache_c fill:#8e44ad,stroke:#6c3483,color:#fff
    classDef store fill:#e67e22,stroke:#ca6f1e,color:#fff
...
flowchart TD
    ...
    classDef q fill:#34495e,stroke:#2c3e50,color:#fff
    classDef art fill:#2c6fad,stroke:#1a4a7a,color:#fff
    classDef cac fill:#8e44ad,stroke:#6c3483,color:#fff
    classDef both fill:#16a085,stroke:#0e6655,color:#fff
    classDef sub fill:#4A90D9,stroke:#2c6fad,color:#fff
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'primaryColor': '#e74c3c', 'primaryTextColor': '#fff', 'primaryBorderColor': '#a93226', 'lineColor': '#555'}}}%%
flowchart LR
    ...
    classDef wrong fill:#e74c3c,stroke:#a93226,color:#fff
    classDef right fill:#6db33f,stroke:#4a8a2a,color:#fff
